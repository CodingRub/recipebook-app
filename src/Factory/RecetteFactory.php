...
final class RecetteFactory extends ModelFactory
{
    ...
    protected function getDefaults(): array
    {
        ...
        for ($i = 0; $i < rand(1, 5); $i++) {
            $ing[] = IngredientFactory::createOne();
        }
        $tags = TagFactory::all();
        ...
        return [
            ...
            'rate' => rand(0, 5),
            'preparation' => [],
            'type' => TypeRecetteFactory::random(),
            'ingredients' => $ing,
            'preparationTime' => '1h00',
            'cookingTime' => '30min',
            'difficulte' => self::faker()->randomElements($difficulte)[0],
            'tags' => self::faker()->randomElements($tags, rand(1, 5)),
            'notes' => [],
        ];
    }
